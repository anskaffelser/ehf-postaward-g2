...
<!--ASSERT -->
   ...
   <axsl:template match=" //cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID" priority="1004" mode="M17">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@schemeID = 'UNCL5305'">
               ...
               <svrl:text>[NOGOV-T14-R012]-A tax category identifier MUST have a scheme identifier attribute 'UNCL5305'.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="@*|*" mode="M17"/>
