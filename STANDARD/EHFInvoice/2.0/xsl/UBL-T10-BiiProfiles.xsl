...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Sjekk Bii profiles" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Sjekk Bii profiles</svrl:text>
...
<!--PATTERN BIIPROFILESUBL-T10-->
   ...
   <axsl:template match="//cbc:ProfileID" priority="1001" mode="M13">
      ...
      <axsl:choose>
         <axsl:when test=". = 'urn:www.cenbii.eu:profile:bii04:ver2.0' or . = 'urn:www.cenbii.eu:profile:bii05:ver2.0' or . = 'urn:www.cenbii.eu:profile:bii06:ver2.0' or . = 'urn:www.cenbii.eu:profile:biixy:ver2.0'"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = 'urn:www.cenbii.eu:profile:bii04:ver2.0' or . = 'urn:www.cenbii.eu:profile:bii05:ver2.0' or . = 'urn:www.cenbii.eu:profile:bii06:ver2.0' or . = 'urn:www.cenbii.eu:profile:biixy:ver2.0'">
               <axsl:attribute name="flag">fatal</axsl:attribute>
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-get-full-path"/>
               </axsl:attribute>
               <svrl:text>[BIIPROFILE-T10-R001]-An invoice transaction T10 must only be used in Profiles 4, 5, 6 or xy.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="/ubl:Invoice" priority="1000" mode="M13">
      ...
      <axsl:choose>
         <axsl:when test="local-name(/*) = 'Invoice' and (//cac:OrderReference/cbc:ID) and //cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver2.0' or not(//cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver2.0')"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="local-name(/*) = 'Invoice' and (//cac:OrderReference/cbc:ID) and //cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver2.0' or not(//cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver2.0')">
               <axsl:attribute name="flag">fatal</axsl:attribute>
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-get-full-path"/>
               </axsl:attribute>
