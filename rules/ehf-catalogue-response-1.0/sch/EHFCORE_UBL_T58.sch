<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" schemaVersion="iso">
  ...
  <pattern>
    <rule context="/p1:ApplicationResponse">
      <assert flag="warning" id="EHF_CORE_R002" test="count(cac:DocumentResponse)&lt;=1">[EHFCORE-T10-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:ApplicationResponse/cac:DocumentResponse">
      <assert flag="warning" id="EHF_CORE_R002" test="count(cac:DocumentReference)=1">[EHFCORE-T10-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cac:Attachment">
      <assert flag="warning" id="EHF_CORE_R001" test="true()">[EHFCORE-T10-R001]-Elements used SHOULD be according to EHF specifications</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:ApplicationResponse/cac:ReceiverParty">
      <assert flag="warning" id="EHF_CORE_R002" test="count(cac:PartyIdentification)&lt;=1">[EHFCORE-T10-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHF_CORE_R002" test="count(cac:PartyName)&lt;=1">[EHFCORE-T10-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
