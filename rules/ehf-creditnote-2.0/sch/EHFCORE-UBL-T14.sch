...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" schemaVersion="iso">
  ...
  <pattern>
    <rule context="/p1:CreditNote/cac:CreditNoteLine">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Note) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:CreditedQuantity) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      ...
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:OrderLineReference) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:BillingReference) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Delivery) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:TaxTotal) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Item) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
  ...
  <pattern>
    <rule context="/p1:CreditNote/cac:CreditNoteLine/cac:BillingReference">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:BillingReferenceLine) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:CreditNote/cac:CreditNoteLine/cac:Item">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Description) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
  ...
  <pattern>
    <rule context="/p1:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:ItemClassificationCode) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule
      context="/p1:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:ID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
