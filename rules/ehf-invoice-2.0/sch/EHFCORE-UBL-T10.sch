...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" schemaVersion="iso">
  ...
  <pattern>
    <rule context="/p1:Invoice">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:UBLVersionID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:CustomizationID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:ProfileID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:InvoiceTypeCode) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Note) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:DocumentCurrencyCode) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:InvoicePeriod) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002"
        test="count(cac:ContractDocumentReference) &lt;= 1">[EHFCORE-T16-R002]-Cardinality SHOULD be
        according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Delivery) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PaymentMeans) &gt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:TaxTotal) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Party) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:AccountingContact">
      <assert flag="warning" id="EHFCORE_T16_R001" test="true()">[EHFCORE-T16-R001]-Elements used
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PartyIdentification) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PartyName) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PostalAddress) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PartyTaxScheme) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PartyLegalEntity) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Contact) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:ID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
      <assert flag="warning" id="EHFCORE_T16_R002" test="@schemeID">[EHFCORE-T16-R002]-Cardinality
        SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:RegistrationName) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:CompanyID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:CityName) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:PostalZone) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Country) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:IdentificationCode) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule
      ...
      <assert flag="warning" id="EHFCORE_T16_R002" test="@listID">[EHFCORE-T16-R002]-Cardinality
        SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:AllowanceCharge">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:TaxCategory) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:InvoiceLine">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Note) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:InvoicedQuantity) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:InvoicePeriod) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:OrderLineReference) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Delivery) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:TaxTotal) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:Price) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:InvoiceLine/cac:Item">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Name) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:ClassifiedTaxCategory) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:ManufacturerParty) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:InvoiceLine/cbc:InvoicedQuantity">
      <assert flag="warning" id="EHFCORE_T16_R002" test="@unitCode">[EHFCORE-T16-R002]-Cardinality
        SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="@unitCodeListID"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:InvoicePeriod">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:StartDate) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:EndDate) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:LegalMonetaryTotal">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:LineExtensionAmount) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:TaxExclusiveAmount) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:TaxInclusiveAmount) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:PaymentMeans">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:PaymentDueDate) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:PaymentID) &lt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:PayeeFinancialAccount) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:TaxExchangeRate">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:CalculationRate) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:MathematicOperatorCode) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/p1:Invoice/cac:TaxTotal">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cac:TaxSubtotal) &gt;= 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:TaxableAmount) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
    <rule context="/p1:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory">
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:ID) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
      <assert flag="warning" id="EHFCORE_T16_R002" test="count(cbc:Percent) = 1"
        >[EHFCORE-T16-R002]-Cardinality SHOULD be according to EHF specifications.</assert>
    </rule>
  </pattern>
  <pattern>
