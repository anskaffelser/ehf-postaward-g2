...
Difi har valgt å basere EHF-formatene på CEN BII og en syntaks implementering basert på link:{link-oasis-ubl}[Universal Business Language (UBL)]. UBL er en fritt tilgjengelig standard som ikke innebærer lisenskostnader, og det samme gjelder for EHF.
