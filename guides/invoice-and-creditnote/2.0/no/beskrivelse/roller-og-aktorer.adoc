...
Kundenummer angis i <cac:PartyIdentification>. Hvilken type aktøridentifikasjon som benyttes, angis i attributtet schemeID. Gyldige verdier må være i henhold til link:https://vefa.difi.no/peppol/standard/identifiers/[PEPPOLs Policy for Identifiers].
