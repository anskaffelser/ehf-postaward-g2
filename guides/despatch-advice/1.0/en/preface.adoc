...
* Chapter 7 gives the complete information contents of the despatch advice.
...
** Appendix 4: Link to UBL 2.1 schema for despatch advice
** Appendix 5: Link to Schematron files used in validation
** Appendix 6: XML example files
** Appendix 7: Conformance statement
