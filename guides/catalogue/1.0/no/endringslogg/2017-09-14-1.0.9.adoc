...
WARNING: Valideringsregler som er ventet å trigge feil i neste release: NOGOV-T19-R024, link:{ruleurl-common}EHF-COMMON-R011[EHF-COMMON-R011], link:{ruleurl-common}EHF-COMMON-R012[EHF-COMMON-R012], link:{ruleurl-common}EHF-COMMON-R013[EHF-COMMON-R013]
