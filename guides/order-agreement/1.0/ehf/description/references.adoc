...
[source,xml,indent=0]
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=CustomerReference]
----
////
...
[source,xml,indent=0]
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=OrderReference]
----
////
<cac:OrderReference>
...
[source,xml,indent=0]
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=Contract]
----
