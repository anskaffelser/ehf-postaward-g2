...
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=PartyIdentification]
----
////
...
[source,xml,indent=0]
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=UBLVersionID]
----
////
...
.Example of usage:
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=ProfileID]
----
////
...
.Example of usage:
----
include::../{xml-doc-dir}ehf-oa-full.xml[tags=CustomizationID]
----
